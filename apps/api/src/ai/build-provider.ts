 ...
 */
export function buildAgentProvider(spec: AiProviderSpec): AgentProvider {
  return spec.provider === 'openai'
    ? new OpenAiAgentProvider(spec.apiKey, spec.model, spec.baseUrl)
    : new AnthropicAgentProvider(spec.apiKey, spec.model);
}
