...
export function entriesDe(assets: Record<string, string>): Entry[] {
  ...
  // --- plans-de ---
  pub('plans-de', 'plan-launch-de', { name: 'Launch', price: 4800, period: 'pro Projekt', monthly: false, featured: false, blurb: 'Ein fokussierter One-Pager, der Sie schnell live bringt.', features: ['One-Page-Website', 'Textfeinschliff', 'Launch in 3 Wochen', 'Technische SEO-Basis'] }),
  pub('plans-de', 'plan-growth-de', { name: 'Growth', price: 9800, period: 'pro Projekt', monthly: false, featured: true, blurb: 'Die vollständige Marketing-Website, die die meisten brauchen.', features: ['Bis zu 10 Seiten', 'Designsystem', 'Blog + CMS-Datensätze', 'Analytics & SEO', '30 Tage Support'] }),
  pub('plans-de', 'plan-flagship-de', { name: 'Flagship', price: 24000, period: 'pro Projekt', monthly: false, featured: false, blurb: 'Strategiegeführt, mehrsprachig, shop-bereit.', features: ['Unbegrenzte Seiten', 'Markenidentität', 'Mehrsprachigkeit', 'Shop & Formulare', 'Prioritäts-Team'] }),
  pub('plans-de', 'plan-care-de', { name: 'Care', price: 450, period: 'pro Monat', monthly: true, featured: false, blurb: 'Hält die Website gesund und aktuell.', features: ['Monatliche Änderungen', 'Uptime- & Speed-Monitoring', 'Dependency-Updates'] }),
  pub('plans-de', 'plan-care-plus-de', { name: 'Care Plus', price: 950, period: 'pro Monat', monthly: true, featured: true, blurb: 'Stetige Verbesserung statt bloßer Pflege.', features: ['Alles aus Care', 'A/B-Experimente', 'Quartalsweises UX-Review', 'Fixes am selben Tag'] }),
