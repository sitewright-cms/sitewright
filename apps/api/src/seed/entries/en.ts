...
export function entriesEn(assets: Record<string, string>): Entry[] {
  return [
  // --- services ---
  pub('services', 'svc-strategy', { icon: 'compass', title: 'Strategy & UX', summary: 'Research, positioning, and user journeys that turn visitors into customers.', price: 'from $4k' }),
  pub('services', 'svc-design', { icon: 'palette', title: 'Web Design', summary: 'Distinctive, on-brand interfaces designed pixel-perfect for every screen.', price: 'from $8k' }),
  pub('services', 'svc-build', { icon: 'code', title: 'Development', summary: 'Hand-built, lightning-fast static sites with top Lighthouse scores.', price: 'from $10k' }),
  pub('services', 'svc-brand', { icon: 'pen-tool', title: 'Brand Identity', summary: 'Logos, type systems, and visual languages that scale across every touchpoint.', price: 'from $6k' }),
  pub('services', 'svc-seo', { icon: 'trending-up', title: 'SEO & Performance', summary: 'Technical SEO, Core Web Vitals, and analytics wired in from day one.', price: 'from $3k' }),
  pub('services', 'svc-care', { icon: 'life-buoy', title: 'Care Plans', summary: 'Ongoing edits, monitoring, and improvements so your site keeps earning.', price: '$450/mo' }),
  ...
  pub('plans', 'plan-launch', { name: 'Launch', price: 4800, display: '$4,800', period: 'per project', monthly: false, featured: false, blurb: 'A focused one-pager that gets you live fast.', features: ['One-page site', 'Copy polish', 'Launch in 3 weeks', 'Technical SEO basics'] }),
  pub('plans', 'plan-growth', { name: 'Growth', price: 9800, display: '$9,800', period: 'per project', monthly: false, featured: true, blurb: 'The full marketing site most clients need.', features: ['Up to 10 pages', 'Design system', 'Blog + CMS datasets', 'Analytics & SEO', '30 days of support'] }),
  pub('plans', 'plan-flagship', { name: 'Flagship', price: 24000, display: '$24,000', period: 'per project', monthly: false, featured: false, blurb: 'Strategy-led, multi-language, e-commerce-ready.', features: ['Unlimited pages', 'Brand identity', 'Multi-language', 'Shop & forms', 'Priority team'] }),
  pub('plans', 'plan-care', { name: 'Care', price: 450, display: '$450', period: 'per month', monthly: true, featured: false, blurb: 'Keep the site healthy and current.', features: ['Monthly edits', 'Uptime & speed monitoring', 'Dependency updates'] }),
  pub('plans', 'plan-care-plus', { name: 'Care Plus', price: 950, display: '$950', period: 'per month', monthly: true, featured: true, blurb: 'Continuous improvement, not just upkeep.', features: ['Everything in Care', 'A/B experiments', 'Quarterly UX review', 'Same-day fixes'] }),
