...
export function entriesEs(assets: Record<string, string>): Entry[] {
  return [
  // --- services-es ---
  pub('services-es', 'svc-strategy-es', { icon: 'compass', title: 'Estrategia y UX', summary: 'Investigación, posicionamiento y recorridos de usuario que convierten visitas en clientes.', price: 'desde 4.000 $' }),
  pub('services-es', 'svc-design-es', { icon: 'palette', title: 'Diseño web', summary: 'Interfaces distintivas y fieles a la marca, al píxel en cualquier pantalla.', price: 'desde 8.000 $' }),
  pub('services-es', 'svc-build-es', { icon: 'code', title: 'Desarrollo', summary: 'Sitios estáticos artesanales y ultrarrápidos con puntuaciones Lighthouse de récord.', price: 'desde 10.000 $' }),
  pub('services-es', 'svc-brand-es', { icon: 'pen-tool', title: 'Identidad de marca', summary: 'Logotipos, sistemas tipográficos y lenguajes visuales que escalan en cada punto de contacto.', price: 'desde 6.000 $' }),
  pub('services-es', 'svc-seo-es', { icon: 'trending-up', title: 'SEO y rendimiento', summary: 'SEO técnico, Core Web Vitals y analítica integrados desde el primer día.', price: 'desde 3.000 $' }),
  pub('services-es', 'svc-care-es', { icon: 'life-buoy', title: 'Planes de mantenimiento', summary: 'Cambios, monitorización y mejoras continuas para que su web siga rindiendo.', price: '450 $/mes' }),
  // --- projects-es ---
  ...
  // --- plans-es ---
  pub('plans-es', 'plan-launch-es', { name: 'Launch', price: 4800, display: '4.800 $', period: 'por proyecto', monthly: false, featured: false, blurb: 'Una one-page enfocada que le pone online rápido.', features: ['Web de una página', 'Pulido de textos', 'Lanzamiento en 3 semanas', 'Base de SEO técnico'] }),
  pub('plans-es', 'plan-growth-es', { name: 'Growth', price: 9800, display: '9.800 $', period: 'por proyecto', monthly: false, featured: true, blurb: 'La web de marketing completa que la mayoría necesita.', features: ['Hasta 10 páginas', 'Sistema de diseño', 'Blog + datos CMS', 'Analítica y SEO', '30 días de soporte'] }),
  pub('plans-es', 'plan-flagship-es', { name: 'Flagship', price: 24000, display: '24.000 $', period: 'por proyecto', monthly: false, featured: false, blurb: 'Guiada por estrategia, multilingüe y lista para vender.', features: ['Páginas ilimitadas', 'Identidad de marca', 'Multilingüe', 'Tienda y formularios', 'Equipo prioritario'] }),
  pub('plans-es', 'plan-care-es', { name: 'Care', price: 450, display: '450 $', period: 'al mes', monthly: true, featured: false, blurb: 'Mantiene la web sana y al día.', features: ['Cambios mensuales', 'Monitorización de uptime y velocidad', 'Actualización de dependencias'] }),
  pub('plans-es', 'plan-care-plus-es', { name: 'Care Plus', price: 950, display: '950 $', period: 'al mes', monthly: true, featured: true, blurb: 'Mejora continua, no solo mantenimiento.', features: ['Todo lo de Care', 'Experimentos A/B', 'Revisión UX trimestral', 'Arreglos el mismo día'] }),
