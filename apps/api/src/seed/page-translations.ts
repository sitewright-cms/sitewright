...
export const PAGE_TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  'comp_slider.sec_hero_d': { de: 'Der klassische Startseiten-Auftakt: Folien mit fester Höhe, Hintergrundbildern, abwechselndem Ken-Burns-Effekt und hereingleitenden Captions. Dieser ganze Block ist das hero-slider-Widget — einsetzen, dann seine Folien, Captions und Einstellungen (inklusive der Slider-Höhe) als Daten bearbeiten. Kein eigenes CSS.', es: 'La apertura clásica de portada: diapositivas de altura fija con imágenes de fondo, un efecto Ken Burns alternante y captions que entran. Todo este bloque es el Widget hero-slider — insértalo y luego edita sus diapositivas, captions y ajustes (incluida la altura del slider) como datos. Sin CSS propio.' },
  'comp_slider.sec_fade_t': { de: 'Slider — die Standardeinstellungen', es: 'Slider — los valores por defecto' },
  'comp_slider.sec_fade_d': { de: 'Ganz ohne Optionen: Die Folien überblenden sanft, an den Kanten liegen vollhohe Verlaufs-Pfeile links und rechts, und eine gefrostete Pille mit Indikatoren sitzt zentriert am unteren Rand.', es: 'Sin opciones: las diapositivas se funden, unas flechas de degradado a toda altura quedan en los bordes izquierdo y derecho, y una píldora esmerilada de indicadores queda centrada abajo.' },
