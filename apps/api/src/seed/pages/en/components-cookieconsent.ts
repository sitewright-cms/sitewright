...
export function pageComponentsCookieConsent(): Page {
  ...
  <p class="mt-5 max-w-2xl text-lg leading-relaxed text-base-content/60" data-sw-translate="comp_cookie.cc_intro">A small consent banner the runtime reveals only until accepted.</p>
</section>

<section class="mx-auto max-w-6xl px-6 pb-20">
  <h2 class="text-3xl font-bold tracking-tight" data-sw-translate="comp_cookie.sec_preview_t">What it looks like</h2>
  <p class="mt-2 max-w-2xl leading-relaxed text-base-content/60" data-sw-translate="comp_cookie.sec_preview_d">A static preview of the banner.</p>
...
<section class="mx-auto max-w-6xl px-6 pb-20">
  <h2 class="text-3xl font-bold tracking-tight" data-sw-translate="comp_cookie.sec_how_t">How it works</h2>
...
<section class="mx-auto max-w-6xl px-6 pb-28">
  <h2 class="text-3xl font-bold tracking-tight" data-sw-translate="comp_cookie.sec_nojs_t">Without JavaScript</h2>
  <p class="mt-2 max-w-2xl leading-relaxed text-base-content/60" data-sw-translate="comp_cookie.sec_nojs_d">No banner appears at all — there is nothing to set or store.</p>
</section>`,
  };
}
