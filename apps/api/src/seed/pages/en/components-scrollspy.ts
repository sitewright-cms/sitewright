...
<div class="mx-auto grid max-w-6xl gap-10 px-6 pb-28 lg:grid-cols-[210px_1fr]">
  ...
  <div class="min-w-0">
    <section id="overview" class="flex min-h-[78vh] scroll-mt-28 flex-col justify-center border-b border-base-200 py-10">
    ...
    <section id="how" class="flex min-h-[78vh] scroll-mt-28 flex-col justify-center border-b border-base-200 py-10">
    ...
    <section id="anchors" class="flex min-h-[78vh] scroll-mt-28 flex-col justify-center border-b border-base-200 py-10">
    ...
    <section id="a11y" class="flex min-h-[78vh] scroll-mt-28 flex-col justify-center py-10">
