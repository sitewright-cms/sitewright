...
<section class="mx-auto max-w-6xl px-6 pb-20">
  ...
  <div class="relative mt-8 mx-auto max-w-3xl" data-sw-component="carousel" data-sw-block="Carousel" data-effect="slide" data-wheel="true" data-autoheight="true" data-arrows="circle" aria-label="{{sw-translate "comp_slider.aria_wheel"}}">
    ...
    <button type="button" data-sw-part="prev" aria-label="{{sw-translate "comp_slider.a_prev"}}" class="!bg-base-200 !text-base-content top-[calc(50%-1.25rem)]">{{sw-icon "caret-double-left:bold" ""}}</button>
    <button type="button" data-sw-part="next" aria-label="{{sw-translate "comp_slider.a_next"}}" class="!bg-base-200 !text-base-content top-[calc(50%-1.25rem)]">{{sw-icon "caret-double-right:bold" ""}}</button>
