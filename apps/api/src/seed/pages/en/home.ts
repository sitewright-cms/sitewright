...
<section class="nw-aurora relative overflow-hidden text-white">
  ...
  <div class="relative mx-auto grid max-w-6xl items-center gap-14 px-6 pb-36 pt-20 lg:grid-cols-[1.05fr_0.95fr] lg:pb-44 lg:pt-28">
    <div class="nw-rise">
      <span class="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-1.5 text-sm font-medium text-white/90 backdrop-blur"><span class="inline-block h-2 w-2 rounded-full bg-secondary"></span><span data-sw-text="hero_eyebrow">Boutique web studio · San Francisco</span></span>
