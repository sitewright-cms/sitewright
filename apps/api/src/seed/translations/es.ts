...
export function translationsEs(assets: Record<string, string>): Record<string, PageTranslationSeed> {
  ...
  components: {
    ...
    navTitle: 'Showcase',
    description:
      'Sliders y galerías en todas las variantes de la plataforma — efectos de fundido y deslizamiento, vistas múltiples con asomo, desplazamiento automático y galerías lightbox.',
    data: {
