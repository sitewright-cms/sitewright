...
describe('dataset + entry content API', () => {
  ...
  it('rejects a dataset whose id does not match the path (409)', async () => {
    ...
    const res = await app.inject({
      method: 'PUT',
      url: `/orgs/${orgId}/projects/${projectId}/content/dataset/posts`,
      cookies: { sw_session: t },
  ...
  it('rejects an invalid dataset field type (400)', async () => {
    ...
    const res = await app.inject({
      method: 'PUT',
      url: `/orgs/${orgId}/projects/${projectId}/content/dataset/bad`,
      cookies: { sw_session: t },
  ...
  it('isolates datasets across tenants', async () => {
    ...
    await app.inject({
      method: 'PUT',
      url: `/orgs/${a.orgId}/projects/${a.projectId}/content/dataset/posts`,
      cookies: { sw_session: a.t },
      payload: dataset,
    });
    const bReadsA = await app.inject({
      method: 'GET',
      url: `/orgs/${a.orgId}/projects/${a.projectId}/content/dataset`,
  ...
  it('isolates entries across tenants (read and write)', async () => {
    ...
    await app.inject({
      method: 'PUT',
      url: `/orgs/${a.orgId}/projects/${a.projectId}/content/entry/post-1`,
      cookies: { sw_session: a.t },
      payload: entry,
    });
    ...
    const bReads = await app.inject({
      method: 'GET',
      url: `/orgs/${a.orgId}/projects/${a.projectId}/content/entry`,
      cookies: { sw_session: b.t },
    });
    ...
    const bWrites = await app.inject({
      method: 'PUT',
      url: `/orgs/${a.orgId}/projects/${a.projectId}/content/entry/post-2`,
      cookies: { sw_session: b.t },
