...
const userSmtpOn: InstanceSettingsStored = { formModes: { globalSmtp: false, userSmtp: true, contactPhp: false, contactPhpSmtp: false, thirdParty: false, whatsapp: false } };
...
describe('ProjectSmtpMailer', () => {
  ...
  it('returns false when the userSmtp mode is disabled instance-wide', async () => {
    ...
    const { sent, factory } = recordingTransport();
    const off: InstanceSettingsStored = { formModes: { globalSmtp: false, userSmtp: false, contactPhp: false, contactPhpSmtp: false, thirdParty: false, whatsapp: false } };
