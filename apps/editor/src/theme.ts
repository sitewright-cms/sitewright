...
//
// Dark mode: the surface helpers carry `dark:` variants (rebound to `[data-theme='dark']` in styles.css)
// so the whole editor flips with the Appearance switcher. The brand helpers (primaryButton, accentChip,
// gradientSurface, gradientHover) are theme-agnostic — the brand gradient reads vivid on both — so they
