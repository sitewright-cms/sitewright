      ...
      <form onSubmit={confirmSetup} className={`flex flex-col gap-4 ${glassCard} p-5`}>
        ...
        <div className="flex flex-col items-center gap-3 sm:flex-row sm:items-start">
          {qr ? (
            ...
            <div className="flex h-44 w-44 items-center justify-center rounded-lg border border-white/60 dark:border-white/10 bg-white/80 dark:bg-slate-900/80 text-xs text-slate-500 dark:text-slate-400">Generating…</div>
          )}
