...
export function UpdateBanner() {
  ...
  if (staleBuild) {
    return (
      <div className="flex items-center justify-center gap-3 border-b border-indigo-200/70 dark:border-indigo-500/20 bg-indigo-100/80 dark:bg-indigo-500/15 px-4 py-2 text-sm text-indigo-900 dark:text-indigo-200 backdrop-blur-3xl">
  ...
  return (
    <div className="flex items-center justify-center gap-3 border-b border-amber-200/60 dark:border-amber-500/20 bg-amber-100/70 dark:bg-amber-500/15 px-4 py-2 text-sm text-amber-900 dark:text-amber-200 backdrop-blur-3xl">
      <span>
