...
const DAISYUI_ITEMS: LibraryItem[] = [
  ...
  daisy('Footer', 'footer site bottom', 'Multi-column footer.', '<footer class="footer bg-neutral text-neutral-content p-10">\n  <nav><h6 class="footer-title">Company</h6><a class="link link-hover" href="/about">About</a></nav>\n</footer>'),
