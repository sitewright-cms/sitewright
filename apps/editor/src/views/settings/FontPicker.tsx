...
function UploadFontForm({
  ...
  return (
    <div className="flex flex-col gap-3 p-5">
      <p className="text-sm text-slate-500">Upload a font you have a license to use. It’s stored in your library and served locally.</p>
      <label className="block">
        <span className="mb-1 block text-xs font-bold uppercase tracking-wide text-slate-500">Font file</span>
      ...
      <label className="block">
        <span className="mb-1 block text-xs font-bold uppercase tracking-wide text-slate-500">Family name</span>
      ...
      <div className="grid grid-cols-3 gap-2">
        <label className="block">
          <span className="mb-1 block text-xs font-bold uppercase tracking-wide text-slate-500">Weight</span>
          <select className={`${glassInput} cursor-pointer`} value={weight} onChange={(e) => setWeight(Number(e.target.value))}>
            {WEIGHTS.map((w) => <option key={w} value={w}>{w}</option>)}
          </select>
        </label>
        <label className="block">
          <span className="mb-1 block text-xs font-bold uppercase tracking-wide text-slate-500">Style</span>
        ...
        <label className="block">
          <span className="mb-1 block text-xs font-bold uppercase tracking-wide text-slate-500">Fallback</span>
