  ...
  return (
    <Tooltip tip={tip} side={side} className="align-middle">
      <button
        type="button"
        aria-label={tip}
        className="inline-flex cursor-help text-slate-500 outline-none transition hover:text-slate-600 focus-visible:text-slate-600 dark:text-slate-400 dark:hover:text-slate-300 dark:focus-visible:text-slate-300"
      >
