...
|---|---|---|---|---|---|---|
| **Component** | Interactive primitive + `data-sw-component` contract (Carousel, Lightbox, Tabs, Modal, Form, Banner, ShaderBg) | element/block | platform | coder/agent (writes the markup) | no — you bring content | `data-sw-component="…"` + `data-sw-part` |
