...
| **C-SNIPPET** | DaisyUI/hand-rolled used where a SW snippet exists | R13, R13a | **etaxi: nav hand-built `<li>`s instead of `nav-header`; How-To/FAQ used DaisyUI tabs not `tabs-mixed`/`tabs-dataset`; tiles not `dataset-grid`** |
