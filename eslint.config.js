...
export default tseslint.config(
  ...
  },
  {
    ...
    files: ['apps/api/src/render/nativize-walk.ts', 'apps/api/src/render/fidelity-extract.ts', 'apps/api/src/render/clone-audit-probe.ts', 'apps/api/src/render/inspect-probe.ts'],
