...
const CURATED = {
  ...
  'credit-card': 'credit-card', percent: 'percent', 'check-circle': 'check-circle',
  ...
  'toggle-left': 'toggle-left', 'toggle-right': 'toggle-right', 'chevrons-up-down': 'caret-up-down',
  ...
  'wand-2': 'magic-wand', wand: 'magic-wand', 'square-pen': 'pencil-simple-line',
