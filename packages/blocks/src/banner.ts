...
export const BANNER_CSS = [
  ...
  '[data-sw-component="banner"][data-sw-banner-shown]{opacity:1;transform:none}',
  ...
  '[data-sw-component="banner"][data-position="center"]{left:50%;top:50%;right:auto;bottom:auto;max-width:min(32rem,calc(100vw - 2rem));transform:translate(-50%,-50%) translateY(10px)}',
  '[data-sw-component="banner"][data-position="center"][data-sw-banner-shown]{transform:translate(-50%,-50%)}',
  '[data-sw-component="banner"][data-position="inline"]{position:static;max-width:none;opacity:1;transform:none}',
...
export const BANNER_JS = `(function(){
  ...
  function reveal(root){
    var run=function(){root.removeAttribute('hidden');(window.requestAnimationFrame||function(cb){setTimeout(cb,16);})(function(){root.setAttribute('data-sw-banner-shown','');});};
