...
body{margin:0;font-family:var(--sw-font-body,ui-sans-serif,system-ui,sans-serif);color:var(--sw-color-ink,#0f172a);background:var(--sw-color-surface,#ffffff);line-height:1.5}
a{color:inherit}
[data-sw-block="Section"]{width:100%;padding:3rem 1.5rem}
[data-sw-block="Section"][data-tone="surface"]{background:var(--sw-color-surface,#ffffff);color:var(--sw-color-ink,#0f172a)}
[data-sw-block="Section"][data-tone="primary"]{background:var(--sw-color-primary,#0ea5e9);color:#ffffff}
[data-sw-block="Section"][data-tone="muted"]{background:#f8fafc;color:var(--sw-color-ink,#0f172a)}
...
[data-sw-part="subtitle"]{margin-top:1.5rem;font-size:1.125rem;color:var(--sw-color-muted,#64748b)}
...
[data-sw-block="Heading"]{font-family:var(--sw-font-heading,inherit);font-weight:700;letter-spacing:-.01em;color:var(--sw-color-ink,#0f172a)}
...
[data-sw-part="nav"]{display:flex;gap:1.5rem;font-size:.875rem;color:var(--sw-color-muted,#64748b)}
[data-sw-block="Footer"]{width:100%;border-top:1px solid #f1f5f9;background:var(--sw-color-surface,#fff)}
[data-sw-block="Footer"]>[data-sw-part="container"]{max-width:64rem;margin:0 auto;padding:2rem 1.5rem;font-size:.875rem;color:var(--sw-color-muted,#64748b)}
