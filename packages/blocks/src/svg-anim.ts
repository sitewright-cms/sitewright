...
const SVG_ANIM_CORE = `
  ...
  function svgReset(m){if(!m.playing)return;m.playing=false;if(m.anim){try{m.anim.cancel();}catch(e){}}if(m.fillAnim){try{m.fillAnim.cancel();}catch(e){}}if(m.strokeAnim){try{m.strokeAnim.cancel();}catch(e){}m.strokeAnim=null;}svgClear(m.el);
