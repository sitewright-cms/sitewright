...
/**
 * Resolve a country-flag icon-font CLASS to a platform flag CODE (for `{{sw-flag}}`), or null. Covers the common flag-font conventions: `flag-icon flag-icon-de` (flag-icon-css),
